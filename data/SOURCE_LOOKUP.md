...
- `data/gic_invoices_FY2014-2026.xlsx` &ndash; GIC monthly invoice ledger, one sheet per fiscal year FY2014&ndash;FY2026 (FY26 partial through 11 months). Columns: month, invoice date, headcount by enrollment category (active, retired, retiree dental, survivor, COBRA), dollar cost by category, full premium, admin fee, roster adjustments, and total amount due.
