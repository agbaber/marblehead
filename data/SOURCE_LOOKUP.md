...
- FY20: [Wayback Machine archive](https://web.archive.org/web/20190723085709/https://www.mass.gov/doc/fy20-gic-rate-sheet/download) of state employee rate sheet (derived from 20% employee share)
- FY23: [mass.gov rate sheet](https://www.mass.gov/doc/active-state-employee-rate-sheet/download)
- FY24: [mass.gov rate sheet](https://www.mass.gov/doc/fy-24-active-employee-rate-chart/download)
...
- [Case studies file](case_studies)
...
## School-Age Population (<abbr class="g" title="American Community Survey">ACS</abbr> B01001, ages 5&ndash;17)
- Source: US Census Bureau, <abbr class="g" title="American Community Survey">ACS</abbr> 5-year estimates, table B01001 "Sex by Age", Marblehead town (FIPS 25-009-38400), end-years 2014&ndash;2023.
...
## <abbr class="g" title="Department of Elementary and Secondary Education">DESE</abbr> Enrollment by Reason (Marblehead district, SY 2014&ndash;2026)
...
- <abbr class="g" title="Marblehead Public Schools">MPS</abbr> resident enrollment = sum where `town_name=Marblehead` (across all enrollment reasons).
- <abbr class="g" title="Metropolitan Council for Educational Opportunity">METCO</abbr> = sum where `enr_reason=METCO`.
...
## <abbr class="g" title="Department of Elementary and Secondary Education">DESE</abbr> School-Attending Children (Marblehead-resident, SY 1985&ndash;2025)
...
- SY 2020 is missing from the source dataset. SY 2007 and SY 2008 have known total-count anomalies; charts compute non-<abbr class="g" title="Marblehead Public Schools">MPS</abbr> totals as the sum of all non-`loc_pub` categories rather than `total_cnt - loc_pub` to avoid those anomalies.
