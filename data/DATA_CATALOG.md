...
- **Caveat:** FY23 jumped +40.5 total town <abbr class="g" title="Full-Time Equivalent">FTE</abbr> (668.50 to 709.00), with the education line gaining +54.31 (482.69 to 537.00) while general gov, public works, human services, and culture/rec each dropped 1&ndash;4 positions. The gain is not real hiring: General Fund education salaries grew 2.6% the same year ($34.4M to $35.3M), nowhere near the ~12% required for 54 net new positions. The FY23 <abbr class="g" title="Annual Comprehensive Financial Report">ACFR</abbr> also rounded all values (537.00 vs prior 482.69), merged Public Safety and Fire into one row, and is silent on methodology. Strong evidence points to a reporting change involving funding-source recategorization (Circuit Breaker revolving-fund spending tripled FY22 to FY23). Town Accountant has not publicly disclosed the specific change. See `inside-school-staffing.html#the-fy23-mystery` for the full breakdown.
- **Confidence:** High for trend; high that FY23 jump is not real hiring. Specific reporting change pending direct confirmation from Town Accountant.
