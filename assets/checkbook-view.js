...
//
// On page load, fetch /data/checkbook_view_FY26.json (the frozen FY26
// year-end snapshot for the spending-by-vote page, generated by
// scripts/build_checkbook_view.py from checkbook_FY26_2026-06-30.csv),
// then walk [data-fill] elements to substitute the snapshot's numbers.
//
...
(function () {
  ...
  function refreshFreshness(view) {
    ...
    var fy = (view.snapshot.fiscal_year || 'FY26');
  ...
  function renderWhatMoved(view) {
    ...
    if (lede) {
      ...
      lede.innerHTML = lineHtml +
        ...
        '<a href="/data/checkbook_view_FY26.json">frozen FY26 view JSON</a> derived from the June 30, 2026 checkbook CSV snapshot.</span>';
    }
    if (ul) {
      ul.innerHTML = '';
  ...
  function init() {
    fetch('/data/checkbook_view_FY26.json', { cache: 'no-store' })
      .then(function (r) {
