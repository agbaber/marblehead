---
slug: select-board-2023-03-08
board: select-board
board_display: "Select Board"
date: 2023-03-08
title: "Select Board: March 8, 2023"
vimeo_id: 806187971
vimeo_url: "https://vimeo.com/806187971"
...
summary_card:
  headline: "Select Board discusses potential Prop 2½ override to address structural deficit and free-cash reliance"
  ...
  votes:
    ...
    - motion: "Accept carved gift from Glover's Regiment"
      result: "in favor (unanimous)"
    - motion: "Tedesco golf outing letters of interest"
      result: "in favor (unanimous)"
    - motion: "Marblehead Counseling Center letter of interest"
      result: "in favor (unanimous)"
    - motion: "Great Marblehead Carnival at Devereaux Beach"
      result: "in favor (unanimous)"
    - motion: "Festival of Arts venue use"
      result: "in favor (unanimous)"
    ...
    - motion: "Declare dog Nala a dangerous dog under MGL Ch. 140 §157"
      result: "in favor (unanimous)"
    - motion: "Pavement management engineering contract with Environmental Partners Group LLC, $100,000"
      result: "in favor (unanimous)"
    ...
    - motion: "Declare two police vehicles surplus"
      result: "in favor (unanimous)"
    - motion: "Approve minutes February 1 and February 8, 2023"
      result: "in favor (unanimous)"
...
topic_segments:
  - topic: permits-zoning
    ...
    start_seconds: 0
    end_seconds: 147
    headline: "Mai Tai Lounge receives amended entertainment license for live music, DJs, and karaoke"
    dek: "The board unanimously approved the expanded entertainment license with hours Monday–Friday 5–10 pm and weekends 12–10 pm, conditioned on music not being audible from the street."
    summary: "Amanda Breen, representing the Mai Tai Lounge at 165 Pleasant Street, requested an amendment to the existing entertainment license to add live music, DJs, and karaoke. The board unanimously approved the request, noting the condition that no music be heard from the street."
    key_speakers: ["Amanda Breen (Mai Tai Lounge applicant)", "Select Board Chair"]
  - topic: admin-housekeeping
    topic_confidence: 0.9
    start_seconds: 165
    end_seconds: 414
    headline: "Glover's Regiment presents carved sycamore gift; Tedesco golf outing approved for nonprofits"
    dek: "The board accepted a wood carving from the Fort Sewell sycamore tree as a gift from Glover's Marblehead Regiment and unanimously approved the semi-annual Tedesco Country Club nonprofit golf outing for May 15, 2023."
    ...
    key_speakers: ["Katie Sullivan (Glover's Regiment)"]
  ...
  - topic: permits-zoning
    ...
    start_seconds: 2065
    end_seconds: 2253
    headline: "One-day liquor licenses approved for Festival of Arts champagne reception and Arts Association jazz events"
    dek: "The board unanimously approved a one-day liquor license for the Festival of Arts at Fort Sewell on June 25 and three one-day licenses for Marblehead Arts Association jazz events at the King Hooper Mansion."
    summary: |
      Two sets of liquor licenses were approved by polled vote:
      
      1. **Festival of Arts** — one-day license for Sunday, June 25, 2023 at Fort Sewell, 4:30–7:30 pm, subject to standard conditions including proof of authorized alcohol source and prohibition on leaving alcohol unattended overnight.
      
      2. **Marblehead Arts Association** — three one-day licenses for March 16, April 13, and May 18, 2023, 6:30–9 pm at the King Hooper Mansion, 8 Hooper Street, for jazz at the Arts performances. Alcohol to be purchased from Cappies Importing and Distribution Company.
  - topic: admin-housekeeping
    topic_confidence: 0.85
    start_seconds: 2299
    end_seconds: 2692
    headline: "Board seeks applications for wine/malt license; sets March 17 deadline for committee vacancies; proclaims Carl Siegel Day"
    dek: "The board authorized a legal notice for a new on-premise wine and malt beverage license, set interview dates for open board and committee vacancies, and unanimously proclaimed March 16 as F. Carlton Siegel Day."
    summary: |
  ...
  - topic: public-safety
    ...
    start_seconds: 2708
    end_seconds: 3654
    headline: "Dog 'Nala' at 45 Pickwick Road declared dangerous under MGL Ch. 140 §157 following two dog-on-dog attacks"
    dek: "Following a hearing held February 15, the board unanimously declared the dog a dangerous dog and imposed conditions including secure fencing, muzzle and leash requirements when off premises, and $100,000 liability insurance."
    summary: |
    ...
    key_speakers: ["Thatcher (Town Administrator)", "Betsy Krueger (Animal Control Officer, referenced)"]
  - topic: trash-dpw
    topic_confidence: 0.88
    start_seconds: 3654
    end_seconds: 4248
    headline: "Board approves $100,000 pavement management engineering contract with Environmental Partners Group"
    dek: "The one-year contract will support development of a five- and ten-year capital plan for pavement management, incorporating utility coordination, complete streets, and the pending pedestrian master plan."
    summary: |
    ...
    key_speakers: ["Amy Mercure (DPW Director, referenced)"]
  - topic: bonding-capital
    topic_confidence: 0.88
    start_seconds: 4261
    end_seconds: 4411
    headline: "Board approves up to $397,290 contract for Village Street bridge design and permitting"
    dek: "The contract with Greenman-Pedersen Inc. covers design and permitting work needed to qualify the bridge replacement for state TIP funding, with the overall replacement project estimated at approximately $2.5–3 million."
    summary: |
  ...
  - topic: admin-housekeeping
    ...
    key_speakers: ["Candice Slyney (Task Force Against Discrimination, referenced)"]
  - topic: override
    topic_confidence: 0.97
    start_seconds: 4749
    end_seconds: 9204
    featured: true
    headline: "Select Board begins override planning amid $2–2.25M budget gap and 10% free-cash reliance"
    dek: "The Town Administrator reported department requests exceed available revenues by $2–2.25 million and that the town relies on approximately $10.5 million in free cash (≈10% of the operating budget), prompting board discussion of two possible override objectives: closing the structural deficit and seeding a stabilization fund."
    summary: |
      ...
      1. **Override to close the structural deficit** — a short-term plug to avoid service cuts while the town builds institutional capacity (staff, financial software) for multi-year planning.
      2. **Override to seed/restore the stabilization fund** — to signal a commitment to reducing free-cash reliance and to bring that reserve into public visibility at town meeting.
    ...
    key_speakers: ["Thatcher (Town Administrator)", "Moses (Select Board Chair)", "Sarah Fox (School Committee Chair)", "Alicia Benjamin (Finance Director)", "Frank (resident, 24 Pickwick Road)"]
  - topic: public-comment
    topic_confidence: 0.9
    start_seconds: 9204
    end_seconds: 9631
    headline: "Public comment focused on override strategy and voter engagement"
    dek: "Two speakers addressed the board: one resident urged extensive community outreach before the override vote; the School Committee chair called for a structurally balanced override ask and concrete communication of service impacts."
    summary: |
    ...
    key_speakers: ["Frank (resident, 24 Pickwick Road)", "Sarah Fox (School Committee Chair)"]
  - topic: admin-housekeeping
    topic_confidence: 0.8
    start_seconds: 9667
    end_seconds: 9933
    headline: "Board notes library groundbreaking and housing production committee updates"
    dek: "Members highlighted the library project groundbreaking and reported that 23 affordable housing units are being added to Marblehead's inventory in 2023 through two existing projects."
    summary: |
...
**[0:00](https://vimeo.com/806187971#t=0s)** Okay. Thank you everybody for standing by. We're just trying to get hooked up. so

**[0:10](https://vimeo.com/806187971#t=10s)** are we all set? All right. I'd like to bring this meeting to order. We have a 21 item agenda tonight and I'm going to jump right in and the first item on the agenda. After I announced that the meeting is being recorded and videotape via Zoom. I thought we had a good news. I guess I need to say it as well. So the first item on the agenda is a entertainment license. And the motion is pretty self-explanatory. It's from Amanda Breen. And it's to include karaoke and DJ and bands at the mai tai Lounge. So the motion that I'd like to entertain is to approve the request from Amanda brain My Thai Lounge to amend the current entertainment license at

**[0:56](https://vimeo.com/806187971#t=56s)** 165 Pleasant Street to include live music DJs and karaoke Monday through Friday, 5:00 pm to 10pm and Saturday and Sundays 12pm to 10 pm subject to no music to be heard from the street.

**[1:12](https://vimeo.com/806187971#t=72s)** And oh, excellent. Please come forward or if you'd like to yeah, that would be great if you wouldn't mind. And have a seat have a seat. Yeah, and you can press on that button right there. and so it turns if you go perfect thank you. If you'd like to give us a little background that would be great is well, we would like to be able to offer karaoke at times and we would also like the ability to you know, have somebody come in like a Char or have a couple people come in to a little singing not all the time that we would like the option to be there. Okay, and through 10 10 pm every night. Sounds good. Any any questions from the woman not a

**[1:58](https://vimeo.com/806187971#t=118s)** question, but just a comment. It looks like a good offering but we are serious about not having anything. outside for people to listen to it needs to be inside and contained because they're our neighbors function of decibel level. Yes. But anyway, that's that's great. Look forward to Coming in on those occasions.

**[2:27](https://vimeo.com/806187971#t=147s)** All right. So we have a we have a motion and a second. Yeah. All in favor. Oh we do. Yeah, I think we've had everybody here we need them. It's a regular voice. It's a regular vote all in favor. Okay, unanimous. Thank you very much relations. Congratulations. Good luck.

**[2:45](https://vimeo.com/806187971#t=165s)** all right, the second on second item on the agenda is a Glover's regiment that's making a gift to the town and I see that Shane both both of these gentlemen are here. Let me do a quick introduction. It's basically a gift to the town and it's a carving from the iconic Fort Sewell tree and from Larry Sands Seamus daily and Katie Sullivan. So if you'd like to

**[3:16](https://vimeo.com/806187971#t=196s)** Give us a little.

**[3:21](https://vimeo.com/806187971#t=201s)** pretty

**[3:25](https://vimeo.com/806187971#t=205s)** do I need to repeat her? Thank you very much. I as long as the microphone is turned on. I need to repeat that. If you if you would that was a great Janice. Thank you. I would like to introduce Katie Sullivan. Who's fought a red Sullivan made this carving and she will deliver the presentation on behalf of her father and of the regiment.

**[3:51](https://vimeo.com/806187971#t=231s)** Good evening. Thank you. This a carving was created by Dr. Ray Sullivan of Middlebury, Connecticut. He's the regimental surgeon for the regiment from wood Salvage from the ancient Sycamore which withstood over 147 years of pounding Gales hurricanes and nor'easters at Fort Sewell. It's presented to the townspeople of Marblehead by the men and women of John Glover's Marblehead Regiment of the Revolution 14th Continentals in appreciation for the cooperation and assistance of town leaders Town businesses and residents in the regiment's mission to keep history alive on the occasion of the anniversary of General Glover's death, January 30th, 2023.

**[4:40](https://vimeo.com/806187971#t=280s)** Thank you very very much. What a lovely what a lovely gift. Thank you.

**[4:57](https://vimeo.com/806187971#t=297s)** Great. Yeah, beautiful. It's really something.

**[5:03](https://vimeo.com/806187971#t=303s)** you

**[5:13](https://vimeo.com/806187971#t=313s)** Represent. Yeah, Larry Larry Larry God

**[5:26](https://vimeo.com/806187971#t=326s)** put Moses in uniform Thank you. Excellent. Thank you. Thank you very much. Thank you. Okay, so Thank you, very very much. That was very tough. That was great. So I'd like to entertain a motion to accept as a gift to the town The Carving made from the iconic Fort Sewell tree and to send a letter of appreciation to Glover's regiment. Thank all those in favor. Unanimous. Thank you very much.

**[6:07](https://vimeo.com/806187971#t=367s)** Okay. So the next item on our agenda is the Tedesco Country Club? Hosts the annual select board golfing event for for nonprofit institutions to be able to go on the course without paying any fees at all. Whether cart fees or or green fees. So the motion self-explanatory to accept letters of interest from any nonprofit organization to use the Tedesco Country Club level May 15th 2023 for the semi-annual Marblehead outing letters of Interest should be submitted by Friday March 17th, 2023 to the select board 188, Washington Street or by email to Wiley Kay at marblehead.org. So

**[6:54](https://vimeo.com/806187971#t=414s)** Second all those in favor unanimous and moving on to the next agenda. And yeah, thanks, sir. Thanks for given to the Tedesco Country Club. That's for sure. That's a wonderful event and and the impact of that event can be seen. Yes. Can we pause for having some audio issues on the On the zoom side, okay.

**[7:27](https://vimeo.com/806187971#t=447s)** Hello. Can you hear us as Jack?

**[7:45](https://vimeo.com/806187971#t=465s)** Said I'll second everybody hear us hopefully. so

**[8:32](https://vimeo.com/806187971#t=512s)** yes, Jack. You just yeah. heard him

**[8:39](https://vimeo.com/806187971#t=519s)** he can't hear us. How many participants do we have on one two three four? one two three

**[8:53](https://vimeo.com/806187971#t=533s)** One Katie was talking was really echoing.

**[9:00](https://vimeo.com/806187971#t=540s)** That's what we're working on. She just said someone texted that we had. No audio. I said that's what we're working on.

**[9:16](https://vimeo.com/806187971#t=556s)** Let me go get mine. So I could pull up my phone too. I mean, yeah, because all you need is the audio right? So we just have to mute this stuff and you'd be the microphone. Oh, sorry, Jack you're still on there the meeting taking place. We have no sound we can hear you.

**[9:54](https://vimeo.com/806187971#t=594s)** Yes.

**[10:29](https://vimeo.com/806187971#t=629s)** Microphones. Yeah penguins

**[10:35](https://vimeo.com/806187971#t=635s)** Can you hear a shack?

**[10:39](https://vimeo.com/806187971#t=639s)** so

**[10:46](https://vimeo.com/806187971#t=646s)** hey Jack, can you hear us?

**[10:53](https://vimeo.com/806187971#t=653s)** Okay. Well, I don't think we can hear them right over. All right. Yeah.

**[11:00](https://vimeo.com/806187971#t=660s)** Okay, that's fine, but they can okay. Well, I'll try to sound off a little bit so you can Be connected to audio not. the Wi-Fi is that we think yeah, like when it asks you to set up connect to and there's like three choices. Might have accidentally hit the wrong one. I'm totally different computer audio. I think we should be on computer we on computer. Yeah, it's obviously our audio is muted. Yeah if they can hear each other.

**[11:31](https://vimeo.com/806187971#t=691s)** Moses I'm gonna hand this to you. This is the paperwork. Oh for that. Thank you landed here. I don't want it to get lost to get lost. So to give it to Jackie. It's not longer or yours. Are you responsibility of handed that off?

**[11:56](https://vimeo.com/806187971#t=716s)** Someone support just maybe write 11.

**[12:04](https://vimeo.com/806187971#t=724s)** doctor cool Thank you. Good idea actually amend that. Because we're just gonna send that to the clever Direction. Or will they fold your letter and maybe we can just go ahead and send. 72 letters Yeah.

**[12:29](https://vimeo.com/806187971#t=749s)** He's a member.

**[12:32](https://vimeo.com/806187971#t=752s)** It was in Connecticut and he comes up here for the summer to do that. Okay to be yeah, and that's what he was. He's at the Urgent. He's at the encampment right here. Can you hear me? I can hear you. Yes, Kyle.

**[12:59](https://vimeo.com/806187971#t=779s)** either You cannot hear us?

**[13:08](https://vimeo.com/806187971#t=788s)** I can set up.

**[13:12](https://vimeo.com/806187971#t=792s)** One get set up here. Yeah, you don't need the screen on you just need the audio Yeah, so you can mute everything there and it'll pull up.

**[13:24](https://vimeo.com/806187971#t=804s)** right

**[13:29](https://vimeo.com/806187971#t=809s)** She should like Kyle. Did you hear that? If you're okay.

**[13:38](https://vimeo.com/806187971#t=818s)** You always have to have one like this.

**[13:44](https://vimeo.com/806187971#t=824s)** You know.

**[13:50](https://vimeo.com/806187971#t=830s)** So I'll do it on my end.

**[13:53](https://vimeo.com/806187971#t=833s)** here

**[13:57](https://vimeo.com/806187971#t=837s)** just give it a minute. I'm going to restart your meeting and then you can all join in again. I assume you heard me because everybody's leaving. All right. Give it a moment.

**[14:15](https://vimeo.com/806187971#t=855s)** They won't give enough time watch those guys. Come back in here.

**[14:26](https://vimeo.com/806187971#t=866s)** Girl, this is the this is the fruit. You're here to see it.

**[14:31](https://vimeo.com/806187971#t=871s)** It's the first time ever we've had this issue.

**[14:47](https://vimeo.com/806187971#t=887s)** She's gonna restart.

**[14:52](https://vimeo.com/806187971#t=892s)** recording in progress

**[15:02](https://vimeo.com/806187971#t=902s)** It's looking promising.

**[15:26](https://vimeo.com/806187971#t=926s)** Jack can you hear us?

**[15:32](https://vimeo.com/806187971#t=932s)** Moses can you cast? Testing one two three. Jack can you hear us? No.

**[15:43](https://vimeo.com/806187971#t=943s)** I'm yeah.

**[15:46](https://vimeo.com/806187971#t=946s)** Do you want to bring your left? Yeah, because I think the Mike will do that on your left.

**[15:52](https://vimeo.com/806187971#t=952s)** Okay. All right. Take a breather.

**[15:58](https://vimeo.com/806187971#t=958s)** Jack I'm just gonna we're gonna bring the laptop.

**[16:05](https://vimeo.com/806187971#t=965s)** please

**[16:11](https://vimeo.com/806187971#t=971s)** yeah.

**[16:20](https://vimeo.com/806187971#t=980s)** Losing everybody.

**[16:28](https://vimeo.com/806187971#t=988s)** Bill now she chants to get out.

**[16:49](https://vimeo.com/806187971#t=1009s)** That's right.

**[16:54](https://vimeo.com/806187971#t=1014s)** It is in the paintings. Those letters are fantastic. Yeah, they really are.

**[17:03](https://vimeo.com/806187971#t=1023s)** Yeah. or a history

**[17:57](https://vimeo.com/806187971#t=1077s)** How you doing?

**[18:18](https://vimeo.com/806187971#t=1098s)** Hello, I can hear you now call.

**[18:22](https://vimeo.com/806187971#t=1102s)** She's in her off. Oh.

**[18:30](https://vimeo.com/806187971#t=1110s)** You know, not the donation.

**[18:36](https://vimeo.com/806187971#t=1116s)** Well, you know, I think what I'll do is I'll just summarize. Okay, wait like my face. Wow, that's you last week. Test it. Hello. We have a look. We have a little bit of an echo the Epic shut down all the yeah.

**[18:56](https://vimeo.com/806187971#t=1136s)** We can hear you. We just can't see you now. That's all. That's that's probably for the better.

**[19:08](https://vimeo.com/806187971#t=1148s)** Okay. Yeah, we still have a pretty bad I see factors also on he may need to somebody. Make make sure you only have one microphone.

**[19:31](https://vimeo.com/806187971#t=1171s)** Hello, who needs? Should we shut these off I tried to mute this we need to mute all that was that SMH? Yeah.

**[20:40](https://vimeo.com/806187971#t=1240s)** start

**[26:56](https://vimeo.com/806187971#t=1616s)** Jack you hear me? okay, so everybody's hang on a minute because I'm going to shut down the system and the other room but I'd give you the host on my computer here in the office. So meeting will run. The video will be on either from the laptop in there are four from the big screen. So I thank you all going to be okay. Jack can you hear we have the Reverb again?

**[27:24](https://vimeo.com/806187971#t=1644s)** Got it.

**[27:35](https://vimeo.com/806187971#t=1655s)** Here such good humor. Yeah.

**[27:50](https://vimeo.com/806187971#t=1670s)** So now we're on this. How are we now?

**[27:59](https://vimeo.com/806187971#t=1679s)** Okay, okay. Well, can we confirm whether folks can hear us?

**[28:08](https://vimeo.com/806187971#t=1688s)** That's where I make it in.

**[28:12](https://vimeo.com/806187971#t=1692s)** Not if he's into here, so that might be the volume up.

**[28:19](https://vimeo.com/806187971#t=1699s)** So far so good.

**[28:28](https://vimeo.com/806187971#t=1708s)** You okay?

**[28:35](https://vimeo.com/806187971#t=1715s)** And you're not okay. Oh, I've also turned off the audio.

**[28:50](https://vimeo.com/806187971#t=1730s)** Jack

**[28:53](https://vimeo.com/806187971#t=1733s)** okay.

**[28:57](https://vimeo.com/806187971#t=1737s)** From your good to go. Okay, and we don't have any feedback.

**[29:04](https://vimeo.com/806187971#t=1744s)** Come on, Dan.

**[29:10](https://vimeo.com/806187971#t=1750s)** All right. Well, I hope everybody is still connected and we really apologize and thank you for keeping your sense of humor. I don't think that will repeat the agenda. But just for everybody's information we had. An annual an amended annual entertainment license for the mai tai Lounge. We received a gift from Glover's regiment. We just completed a vote for the Tedesco by annual golf tournament

**[29:45](https://vimeo.com/806187971#t=1785s)** And made a emotion to accept letters of Interest. And I just want to say that's a very generous gift from the from Tedesco Country Club. Because it has a real impact on the nonprofits that take part in that golf tournament, and the next motion is a letter of application from the Marblehead Counseling Center. And they write that the select boards charitable event has added over 25,000 to mcc's development efforts in the past tournament years. For small organization like MCC the economics of a gulf event is not profitable unless the tournament course is donated a rare occurrence these days. So that's that's a big deal.

**[30:31](https://vimeo.com/806187971#t=1831s)** And what we'd like to do is to make a motion to accept this letter from Ruth Ferguson the president of the board of directors of the Marblehead Counseling Center. To accept this letter of interest from the Marblehead Counseling Center. so, right second all those in favor unanimous great. Okay. So we go on to agenda item five and this is the great Marblehead Carnival request. It is the motion is a self-explanatory. Basically the carnival operates between six and 10:30 on May 4th and Fifth and between one and 10:30 pm on May 6th. And the motion to be entertained is as follows motion to approve your request to
...
**[1:30:57](https://vimeo.com/806187971#t=5457s)** To have the department heads. Have the ability to have bottom line numbers to create a balanced budget based on the revenues that we estimate that we have at this time. So that's that's where we're
