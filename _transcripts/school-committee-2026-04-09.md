---
slug: school-committee-2026-04-09
board: school-committee
board_display: "School Committee"
date: 2026-04-09
title: "School Committee: April 9, 2026"
vimeo_id: null
vimeo_url: "https://www.youtube.com/channel/UC3mmZuBmhKUJsXeWbqwFQJQ"
duration_seconds: 10800
ai_generated: true
status: published

summary_card:
  headline: "Student-led Magic Coalition presents; FY27 budget cut $3.16M; override tiers and tri-board MOU approved"
  summary: >
    A routine three-hour committee meeting: recognitions, a financial update,
    a student presentation from the Magic Coalition, a Portugal field-trip
    approval, the line-by-line FY27 budget vote ($47.62M, down $3.16M with
    22 positions reduced), the school side of the tri-board override tiers
    ($6.2M / $7.2M / $8.5M), MOU support, plus consent items and subcommittee
    updates.
  ...
  votes:
    - motion: "Approve Portugal field trip request (April 15-24, 2026)"
      result: "5-0 (Jen, Henry, Melissa, Kate, Al)"
    - motion: "Approve FY27 line-item budget as presented ($47,620,287)"
      result: "5-0 (Jen, Henry, Melissa, Kate, Al)"
    - motion: "Approve three-tier school-side override structure ($6.2M / $7.2M / $8.5M)"
      result: "4-0 (Jen left at 7:30; Henry, Melissa, Kate, Al)"
    - motion: "Approve draft tri-board MOU subject to numbers being added to override structure section"
      result: "4-0 (Henry, Melissa, Kate, Al)"
    - motion: "Approve consent: bills schedules ($443,690.77) and minutes (March 12 and March 27)"
      result: "in favor (voice vote)"
    - motion: "Declare athletic equipment (per Ken's memo) as surplus"
      result: "in favor (voice vote)"
    - motion: "Accept Tommo Tackle donation ($215) for the Borndale trip"
      result: "in favor (voice vote)"
...
topic_segments:
  ...
  - topic: school-budget
    ...
    start_seconds: 1900
    end_seconds: 5400
    headline: "FY27 budget approved at $47.62M, down $3.16M with 22 positions cut"
    dek: "Mix of vacancies (11) and filled positions (11) reduced; $1.5M prepaid tuition draws down the safety net to its floor."
    summary: |
      ...
      | School/area | Items |
      |---|---|
      | Brown | level-fund supplies (&minus;$1,800); reduce a full-year clerical to 195-day; reduce 1 custodian; 1.24 FTE general-ed IA shifted to grant funding |
      | Glover | vacant SIP teacher; vacant 0.4 EL teacher; level-fund supplies (&minus;$1,600); custodian; PreK Weds 2-hour reduction |
      | Village | vacant 1.75 EL teacher; vacant SPED teacher; 1 elementary teacher (location TBD); 1 of 3 IAs; &minus;$2,600 supplies/contract/PD; part-time paraprof |
      | Veterans | math interventionist; 1 teacher; level-fund supplies (&minus;$1,600); paraclerical |
      | High school | already-rolled 0.2 art FTE; 2 teachers moved to revolving fund; 3 classroom teachers; level-fund supplies (&minus;$4,000) |
      | Athletics | level-fund supplies (&minus;$3,000) |
      ...
      Plus: **0.4 SLP reduction**, **pause the curriculum-refresh cycle**, **&minus;$137,938 daily-substitute line** (building subs working), 1.0 maintenance cut, heating-fuel and electricity reductions tied to the new contract and usage.
  ...
  - topic: override
    ...
    key_speakers: ["John (Superintendent)", "Mike (Asst Supt of Finance)", "Jen (chair)", "Kate", "Melissa", "Sarah (resident)"]

  - topic: override
    topic_confidence: 0.90
    start_seconds: 7800
    end_seconds: 8700
    headline: "Tri-board MOU approved subject to dollar figures being inserted"
    dek: "Same MOU the Select Board previewed on April 8; commitment of no further general override until at least FY2030."
    summary: |
    ...
    key_speakers: ["Kate", "Mike (Asst Supt of Finance)", "Henry", "Melissa", "Al"]

  - topic: school-budget
    topic_confidence: 0.85
    start_seconds: 900
    end_seconds: 1500
    headline: "FY26 unencumbered balance just under $2.1M; $1.5M earmarked for prepaid tuition"
    dek: "Monthly financial update plus unexpected HVAC, bus, and elevator repairs in March."
    summary: |
  ...
  - topic: recreation-events
    ...
    start_seconds: 1500
    end_seconds: 1900
    headline: "Portugal field trip approved for April 15-24, 2026"
    dek: "Lisbon and Porto base cities; same vendor and tour guide as last year's trip after weather rerouting."
    summary: |
      ...
      Vote: **5-0**.
    key_speakers: ["Kelly (Lead World Language Teacher)", "Jen (chair)", "Henry", "Melissa", "Kate", "Al"]

  - topic: admin-housekeeping
    topic_confidence: 0.85
    start_seconds: 60
    end_seconds: 900
    headline: "Recognitions, MECCO advocacy day, and a joint letter on student safety"
    dek: "Suffs Broadway visit, Drive to Stay Alive parent night, COA panel with all department heads, and a coming joint letter from the chief and Tucker."
    summary: |
  ...
  - topic: admin-housekeeping
    ...
    start_seconds: 8700
    end_seconds: 9300
    headline: "Bills, surplus, and a $215 donation for the Borndale fishing trip"
    dek: "Routine consent: bill schedules at $443K, athletic equipment surplus, and a tackle-shop donation."
    summary: |
  ...
  - topic: admin-housekeeping
    ...
    start_seconds: 9300
    end_seconds: 9700
    headline: "Calendar shuffle: June 18 → June 11; April 16 → April 30"
    dek: "Election cycle alignment for June; member availability for April."
    summary: |
  ...
  - topic: admin-housekeeping
    ...
    start_seconds: 9700
    end_seconds: 10800
    headline: "Subcommittee updates: roofs on schedule, CPAC recruiting, wellness policy done"
    dek: "Vets and HS roof projects tracking; CPAC light on agenda; wellness committee finished its policy revision."
    summary: |
      ### Roof subcommittee
      ...
      ### Policy Subcommittee
      No formal update.
    key_speakers: ["Kate", "Henry", "John (Superintendent)"]

associated_documents:
  - label: "FY27 Marblehead Public Schools line-item budget"
    note: "Approved 5-0 at this meeting; $47,620,287 total. Distributed in board packet; not yet on the school department website."
  - label: "FY27-FY29 tri-board override draft Memorandum of Understanding"
    note: "Six-page draft; voted 4-0 here subject to dollar figures being added to the override structure section. Same MOU previewed at Select Board on April 8."
  ...
  - label: "Tommo Tackle donation letter ($215)"
    note: "Borndale outdoor-education trip; rod/reel + gift certificates. Standard donation acceptance."
  - label: "March 12 and March 27, 2026 meeting minutes"
    note: "Approved as part of consent."
  - label: "Bills schedules totaling $443,690.77"
    note: "Standard consent; no objection."

ingest:
  transcribed_at: "2026-04-09T22:30:00Z"
  speech_model: "manual"
  source: "data/school_committee_2026-04-09_transcript.txt"
  summary_model: "claude-opus-4-7"
  summary_method: "in-context summarization (no API call; transcript read directly)"
  notes: |
    School Committee meetings are published on the SC's own YouTube channel
    (https://www.youtube.com/channel/UC3mmZuBmhKUJsXeWbqwFQJQ), not the MHTV
    Vimeo channel. The vimeo_id field is null and the vimeo_url points at the
    YouTube channel root, since the per-meeting video ID was not resolved
    here. Phase 2 scaling work needs to:
      1. add a generic source_url + source_label schema rather than vimeo_*,
      2. handle YouTube transcripts via yt-dlp (it supports YT) in addition
         to Vimeo-hosted MHTV content,
      3. resolve per-meeting video IDs from the SC YouTube uploads.

    start_seconds estimates here are coarse (202 transcript lines / ~180 min
    = ~53 sec/line). Lead segment (Magic Coalition) was placed first by
    setting featured: true; the budget vote is a secondary card even though
    it is the procedurally heaviest item, since the user's frame for this
...
## Override tier endorsement (approx. 1:30:00 &ndash; 2:15:00)
...
## Tri-board MOU support (approx. 2:15:00 &ndash; 2:30:00)
...
## Public comment after the override vote (approx. 2:30:00 &ndash; 2:40:00)
...
## Consent items and other business (approx. 2:40:00 &ndash; 3:00:00)
