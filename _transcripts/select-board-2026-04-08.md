---
slug: select-board-2026-04-08
board: select-board
board_display: "Select Board"
date: 2026-04-08
title: "Select Board: April 8, 2026"
vimeo_id: 1181632658
vimeo_url: "https://vimeo.com/1181632658"
...
summary_card:
  ...
  votes:
    - motion: "Appoint Katherine Zukowski to Cultural Council, term ending June 2029"
      result: "in favor (voice vote)"
    - motion: "Continue Shindonisi revocation hearing to April 22, 2026"
      result: "in favor (voice vote)"
    - motion: "Reauthorize Board of Health commercial waste-disposal revolving fund at $1.3M for FY27 (supersedes Feb 11, 2026 motion)"
      result: "in favor (voice vote)"
    - motion: "Approve FY27 warrant articles 3, 4, 6, 7, 8, 9, 10, 11, 12, 13, 15, 16, 17, 18, 23, 31, 33, 36 (with holds on 19, 21, 29, 34)"
      result: "in favor (voice vote)"
    - motion: "Approve Article 21 Essex North Shore Agricultural & Technical at $749,920"
      result: "in favor (voice vote)"
    - motion: "Amend overnight parking-ban dates to April 27 - May 1, 12:01 AM - 7:00 AM"
      result: "in favor (voice vote)"
    - motion: "Renew Eastern Yacht Club all-day alcohol seasonal club pool license"
...
topic_segments:
  ...
  - topic: trash-dpw
    ...
    summary: >
      ...
      (projection includes 5% contract growth). If the fee stays, eligible
      tax-abatement households would receive a discount and all residents
      could opt out by using the existing $150 transfer-station sticker.
      Board of Health is implementing the fee regardless as part of the
      balanced budget; the override question simply lets voters choose how
      to fund it.
    key_speakers: ["Matt Fernald (CFO)", "Dan Fox (chair)"]
  - topic: override
    topic_confidence: 0.95
    start_seconds: 6500
    end_seconds: 8300
  ...
  - topic: admin-housekeeping
    ...
    summary: >
      ...
      Town Administrator Thatcher argued it duplicates the administrative chain
      and creates governance conflict; Jim defended it citing recent useful
      coordination on the Reynolds Playground and Brown School Building Committee
      projects. Board explored whether a redesigned committee chaired by the
      Town Administrator could preserve the inter-departmental coordination
      benefit while resolving the conflict. Article 35 (modernize the same
      committee) was not yet discussed.
    key_speakers: ["Jim", "Thatcher (Town Administrator)", "Dan Fox (chair)", "Moses", "Alexis"]
  - topic: public-safety
    ...
    summary: >
      ...
      noted April 20-24 falls on school vacation week when many cars are left
      curbside. Sweeping must be done before Mother's Day (Piper and Fluffy
      season starts).
  ...
  - topic: admin-housekeeping
    ...
    summary: >
      ...
      renewed; consent agenda approved (Abbot Hall reservations for the
      Marblehead School of Music, National Prayer Day, Marblehead Charter
...
associated_documents:
  ...
  - label: "DOR override ballot calculator (linked from marmala.org process flow)"
    note: "Resident Constance referenced marmala.org/ ballot-question-committee process diagram; CFO referenced the DOR override-impact tool for per-home tax calculations"
  - label: "Existing tax-abatement program (assessor's office)"
    note: "Discount eligibility for trash fee under fee-funded scenario tied to existing tax-abatement qualification"
  - label: "$150 transfer-station sticker program"
    note: "Existing opt-out alternative to curbside fee"

ingest:
  transcribed_at: "2026-04-08T22:00:00Z"
  speech_model: "manual"
  source: "data/select_board_2026-04-08_transcript.txt"
  summary_model: "claude-opus-4-7"
  summary_method: "in-context summarization (no API call; transcript was small enough to read directly)"
...
## Cultural Council appointment (approx. 16:00 &ndash; 18:00)
...
- Free-cash reliance steps down: $5M (FY26) &rarr; $4M (FY27) &rarr; $3M (FY28).
