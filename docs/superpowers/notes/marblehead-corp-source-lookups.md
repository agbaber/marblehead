...
| Bond Rating | AAA (S&P), outlook negative as of April 10, 2026 | S&P Global Ratings letter to Finance Director Aleesha Benjamin, April 10, 2026, archived as [`2026-04-10_SP_Rating_Letter.pdf`](https://github.com/agbaber/marblehead/releases/download/source-archive-v1/2026-04-10_SP_Rating_Letter.pdf), reference 40447311. (Note: scaffold's Aa1/Moody's placeholder is incorrect &mdash; Marblehead's current rating is AAA from S&P, not Aa1 from Moody's. Use AAA / S&P / outlook negative.) |
...
| Stabilization Fund / Free Cash | Free cash $9,488,848 (FY26 certified) | DOR `dor_all_351_FY26.csv` (Marblehead row, free_cash column). The Town does not maintain a separately-named "Stabilization Fund" line in its operating budget (FY27 proposed budget line 229 "Stabilization Fund" = $0 for FY25, FY26, and FY27). The override deck's Tier 1 explicitly proposes restoring a stabilization-fund transfer that has been zero in recent operating budgets. Use certified Free Cash as the closest publicly-reported reserve indicator; footnote that Marblehead has not been funding a stabilization-fund line item. |
...
- **Industry comparable A:** Eastern Bankshares (NASDAQ: EBC), CEO Denis K. Sheahan (CEO since July 2024). FY2024 reported total compensation: $1,291,168 (Total Cash $745,262 + Equity $530,309 + Other $15,597). Source: Salary.com executive compensation database, citing Eastern Bankshares' 2024 annual proxy (DEF 14A): [salary.com Eastern Bankshares Inc executive salary page](https://www.salary.com/research/executive-compensation/eastern-bankshares-inc-executive-salary). Caveat: Sheahan only became CEO in July 2024 mid-year, so the 2024 figure reflects a partial year as CEO; the proxy's CEO Pay Ratio section references a higher annualized total of $4,186,137 used for the 41:1 ratio. Use the $1.29M Summary-Compensation-Table figure as the cleanest single-year disclosed number, footnoting that 2024 was a transition year. For a fully-annualized comparable, the page can alternatively cite "approximately $1.69M" per Simply Wall St's reading of the same proxy; pick one and footnote the source.
- **Industry comparable B:** L.L. Bean &mdash; **DROPPED**. L.L. Bean is privately held; no SEC-filed compensation disclosure exists for CEO Stephen Smith. Comparably's executive-salary range (~$700K for "most compensated executive") is not specifically attributed to Smith and is not a primary source. Per the task plan ("If only one clean comparable is findable, drop the second"), the page should use Eastern Bankshares alone. The Executive Compensation section can present one comparable rather than two, or convert to a single-comparable framing.
