...
- **Industry comparable A:** Eastern Bankshares (NASDAQ: EBC), CEO Denis K. Sheahan (CEO since July 2024). **DECIDED: use the proxy's Summary Compensation Table figure of $1,291,168 for FY2024.** Source: Eastern Bankshares 2024 DEF 14A proxy statement (cited via Salary.com executive compensation database: [salary.com Eastern Bankshares Inc executive salary page](https://www.salary.com/research/executive-compensation/eastern-bankshares-inc-executive-salary)). The page's footnote should note that Sheahan became CEO in July 2024 (mid-year transition), so the $1.29M figure reflects a partial year as CEO. Do not use the annualized $4,186,137 (CEO Pay Ratio purposes only) or Simply Wall St's $1.69M (secondary derived figure). Stick to the SCT primary number with the partial-year caveat.
