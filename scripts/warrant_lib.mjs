...
export const ALIASES = {
  ...
  'transfer funds to the special education stabilization account': 'transfer funds to special education stabilization account',
...
export const KIND_BY_SLUG = {
  ...
  'collective-bargaining-iue-cwa-local-1776': 'money_article',
